...
struct OrchardgrassView: View {
    @State private var rotateDegree: Double = 0
    var body: some View {
        VStack{
            
            Text("Orchardgrass").font(.system(size: 30)).foregroundColor(Color.green)
            Button("Dactylis glomerata") {
                rotateDegree = 360
            }
            .font(.title)
...
struct OrchardgrassView_Previews: PreviewProvider {
